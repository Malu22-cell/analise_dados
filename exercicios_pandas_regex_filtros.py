...
"""
# RESOLUCAO
filtro = df["nome_aluno"] == "Maria Luísa Serakides"
df.loc[filtro,:]
...
"""
# RESOLUCAO
filtro = df["nome_alunos"].str.contains("Silva$", case=False)
df.loc[filtro, :]
...
filtro = df["nome_alunos"].str.contains("ˆM")
df.loc[filtro, :]
...
filtro = df["nome_alunos"].str.contains("ˆ[ABC]")
df.loc[filtro, :]
...
filtro = df["nome_alunos"].str.contains("ˆ(Ana|Maria)",case=False)
df.loc[filtro, :]
...
filtro = df["nome_alunos"].str.contains("paulo" ,case=False)
df.loc[filtro, :]
...
# r"^[A-Za-z]+ [A-Za-z]+$"
# RESOLUCAO
filtro = df["nome_alunos"].str.contains(r"^[A - Z] + [A - Z] + $",case=False)
df.loc[filtro, :]
...
filtro = df["nome_alunos"].str.contains(r"^[A - Z] + [A - Z] + [A - Z] + $",case=False)
df.loc[filtro, :]
...
filtro = df["nome_alunos"].str.contains(r"(Silva|Santos)",case=False)
df.loc[filtro, :]
...
filtro = df["nome_alunos"].str.contains(r"(Costa|Alves)$",case=False)
df.loc[filtro, :]
...
filtro = df["nome_alunos"].str.contains(r"[A - Z]+",case=False)
df.loc[filtro, :]
...
filtro = df["nome_alunos"].str.contains("ˆ[A - Z]")
df.loc[filtro, :]
...
filtro = df["nome_alunos"].str.contains("maria",case=False)
df.loc[filtro, :]
...
filtro = df["nome_alunos"].str.contains(r"^[A - Z] + [A - Z] + (Souza|Lima|Rocha)$",case=False)
df.loc[filtro, :]
